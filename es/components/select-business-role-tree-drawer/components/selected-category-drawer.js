...
export default (function (props) {
  ...
  var columns = [{
    ...
    render: function render(a, records) {
      return /*#__PURE__*/React.createElement("div", {
        ...
        overlayClassName: "selected-business-role-popover",
        getPopupContainer: function getPopupContainer() {
          return document.querySelector('.selected-business-role-table');
        }
  ...
  return /*#__PURE__*/React.createElement(Drawer, {
    className: "selected-business-role-drawer-tree-wrapper",
    ...
    className: "selected-business-role-table drawer-body-content"
  }, /*#__PURE__*/React.createElement("div", {
