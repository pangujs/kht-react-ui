...
export default (function (props) {
  ...
  var columns = [{
    ...
    render: function render(a, records) {
      return /*#__PURE__*/React.createElement("div", {
        ...
        overlayClassName: "selected-dept-popover",
        getPopupContainer: function getPopupContainer() {
          return document.querySelector('.selected-dept-table');
        }
  ...
  var deleteCheckedItems = function deleteCheckedItems(type) {
    if (!selectedRowKeys.length && type != 'all') return;
  ...
  return /*#__PURE__*/React.createElement(Drawer, {
    className: "selected-department-drawer",
    ...
    className: "table-content selected-dept-table"
