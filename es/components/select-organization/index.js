...
import SelectOrganizationDrawer from './components/selected-organization-drawer';
import "./index.css";
...
var SelectTagCategory = function SelectTagCategory(props) {
  var _props$open = props.open,
    open = _props$open === void 0 ? false : _props$open,
    _props$title = props.title,
    title = _props$title === void 0 ? '选择机构' : _props$title,
  ...
  var onLoadMore = function onLoadMore(currentData) {
    return new Promise( /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(resolve) {
        ...
        var actions, result, childrenData, _result$response, list;
  ...
  var selectedRowKeys = useMemo(function () {
    ...
    return checkedItems.filter(function (item) {
      return !idList.includes(item.parentId);
    });
  }, [checkedItems]);
  var footerRender = /*#__PURE__*/React.createElement("div", {
    className: "drawer-tree-footer"
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Drawer, {
    ...
    title: title,
    width: width,
    className: "organization-drawer-tree-wrapper",
    onClose: onCancel,
  ...
  }, selectedRowKeys.length)), /*#__PURE__*/React.createElement(SelectOrganizationDrawer, {
    open: selectedOpen,
...
export default SelectTagCategory;
