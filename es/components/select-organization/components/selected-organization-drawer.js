...
import { Drawer, Dropdown, Button, Pagination, ConfigProvider, message, Tooltip } from 'antd';
import "../index.css";
import DrawerProTable from '../../drawer-pro-table';
import zhCN from 'antd/es/locale/zh_CN';
import { cloneDeep } from 'lodash';
import { KhtDeptUserIconType } from '../../../index';
export default (function (props) {
  ...
  var columns = [{
    ...
    render: function render(a, records) {
      ...
      }, KhtDeptUserIconType.dept), /*#__PURE__*/React.createElement(Tooltip, {
        getPopupContainer: function getPopupContainer() {
          return document.querySelector('.organization-selected-drawer');
        },
  ...
  return /*#__PURE__*/React.createElement(Drawer, {
    className: "organization-selected-drawer",
    ...
    className: "selected-organization-drawer-body-content"
  }, /*#__PURE__*/React.createElement("div", {
