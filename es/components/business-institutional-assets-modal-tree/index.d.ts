...
import { IconType } from '../business-institutional-assets-tree';
import { InputProps } from 'antd';
type InstitutionalAssetsPropsType = {
    /**
     * @description 弹层的状态
     * @default false
     */
    open: boolean;
    /**
     * @description 弹层的状态, 兼容 antd 4.23 前版本
     * @default false
     */
    visible?: boolean;
    /**
...
declare const BusinessInstitutionalAssetsModalTree: React.ForwardRefExoticComponent<InstitutionalAssetsPropsType & React.RefAttributes<InstitutionalRefActionType>>;
