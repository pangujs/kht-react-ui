...
type CategoryDrawerTreePropsType = {
    /**
     * @description 弹层的状态
     * @default false
     */
    ...
    /**
     * @description 仅加载到某个层级 分类-分组-标签
     * @default undefined
     */
    loaderLevel?: 'category' | 'group' | 'tag';
    /**
...
declare const BusinessCategoryDrawerTree: (props: CategoryDrawerTreePropsType) => JSX.Element;
export default BusinessCategoryDrawerTree;
export declare const API: (props: CategoryDrawerTreePropsType) => JSX.Element;
