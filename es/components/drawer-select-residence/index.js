...
import { getResidentTreeData } from './api';
import { objArrayRemoval } from '../../utils';
import SelectedDepartmentDrawer from './selected-residence-drawer';
import { cloneDeep } from 'lodash';
export default function DrawerSelectResidence(props) {
  var treeRef = useRef();
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 4;
            return getResidentTreeData(data);
          case 4:
          ...
          case 8:
            setState({
              ...
              projectName: treeData[0] ? treeData[0].name : ''
            });
          case 9:
          case "end":
  ...
  return /*#__PURE__*/React.createElement(Drawer, {
    className: "select-residence-drawer",
  ...
  }, /*#__PURE__*/React.createElement("p", null, "\u9879\u76EE\uFF1A", state.projectName), open ? /*#__PURE__*/React.createElement(KhtBaseTree, {
    ref: treeRef,
