...
export default (function (props) {
  ...
  var columns = [{
    ...
    render: function render(a, records) {
      console.log(records, '77777');
      return /*#__PURE__*/React.createElement("div", {
        className: "row"
      }, KhtBusinessInstitutionalIconType[records.sourceTableType], /*#__PURE__*/React.createElement(Popover, {
        placement: "bottomLeft",
        content: records.fullName,
        overlayClassName: "selected-residence-popover",
        getPopupContainer: function getPopupContainer() {
          return document.querySelector('.selected-residence-table');
        }
  ...
  return /*#__PURE__*/React.createElement(Drawer, {
    className: "selected-residence-drawer",
    ...
    className: "selected-residence-table table-content"
