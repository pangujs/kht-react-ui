...
import TagCategorySelect from '../../select-tag-category';
...
export var TagSearch = function TagSearch(props) {
  ...
  var searchInput = _debounce( /*#__PURE__*/function () {
  ...
  var typeOption = useMemo(function () {
    var all = {
      dictValue: '',
      name: '全部'
    };
    var _ref2 = props || {},
      _ref2$tagTypeOptions = _ref2.tagTypeOptions,
      tagTypeOptions = _ref2$tagTypeOptions === void 0 ? [] : _ref2$tagTypeOptions;
    return [all].concat(_toConsumableArray(tagTypeOptions));
  }, [props.tagTypeOptions]);
  useEffect(function () {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }), !props.batchEdit && /*#__PURE__*/React.createElement(Select, {
    placeholder: "\u6807\u7B7E\u6765\u6E90",
    style: {
      width: '108px',
      marginLeft: 10
    ...
    placeholder: "\u641C\u7D22",
    prefix: SearchIcon
  }))), /*#__PURE__*/React.createElement(TagCategorySelect, {
    open: openCategory,
    title: "\u9009\u62E9\u6807\u7B7E\u5206\u7C7B",
