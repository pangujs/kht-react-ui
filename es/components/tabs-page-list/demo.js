...
import KhtTabsPageList from '@src/tabs-page-list';
...
export default (function () {
  ...
  var _useState3 = useState('/represent-order/all'),
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(KhtTabsPageList, {
    ...
    tabsPrpos: {
      items: [{
        label: '全部处理人',
        key: '/represent-order/all'
      }, {
        label: '我处理的',
        key: '/represent-order/handle'
      }, {
        label: '抄送我的',
        key: '/represent-order/send'
      }, {
        label: '我代报的',
        key: '/represent-order/represent'
      }, {
        label: '我转交的',
        key: '/represent-order/hand-over'
      }],
      activeKey: activeKey,
