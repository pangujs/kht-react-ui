...
export default (function (props) {
  ...
  var columns = [{
    ...
    render: function render(a, records) {
      return /*#__PURE__*/React.createElement("div", {
        ...
        content: '全部分类/' + records.tableName,
        overlayClassName: "selected-tag-category-popover",
        getPopupContainer: function getPopupContainer() {
          return document.querySelector('.selected-tag-category-table');
        }
  ...
  return /*#__PURE__*/React.createElement(Drawer, {
    className: "business-selected-drawer",
    ...
    className: "selected-tag-category-table table-content"
