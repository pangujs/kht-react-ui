...
type RoleDrawerPropsType = {
    ...
    /**
     * @description 角色类型, organization-组织角色， business-业务角色
     * @default business
     */
    roleType?: 'organization' | 'business';
    /**
     * @description 预览数据
     * @default []
     */
...
declare const BusinessRoleDrawer: (props: RoleDrawerPropsType) => JSX.Element;
export default BusinessRoleDrawer;
export declare const API: (props: RoleDrawerPropsType) => JSX.Element;
