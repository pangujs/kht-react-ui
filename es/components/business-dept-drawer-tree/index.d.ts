...
declare const BusinessDeptDrawerTree: (props: DeptDrawerTreePropsType) => JSX.Element;
export default BusinessDeptDrawerTree;
export declare const API: (props: DeptDrawerTreePropsType) => JSX.Element;
