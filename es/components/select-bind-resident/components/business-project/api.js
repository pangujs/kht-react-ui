...
//客户中台获取项目数据新
export var getProjectTableDataNew = function getProjectTableDataNew(params, data) {
  return Request.post("/api/v1/estate/components/community/getCustomerCommunityList", data);
};
//中台端======获取项目数据
