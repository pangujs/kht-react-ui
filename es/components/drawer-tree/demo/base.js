...
import KhtDrawerTree from '@src/drawer-tree';
...
export default (function () {
  ...
  var _useState25 = useState(false),
    ...
    isReviewMode = _useState26[0],
    setIsReviewMode = _useState26[1];
  ...
  /** 是否开启查看模式 */
  var onHandleModeChange = function onHandleModeChange(checked) {
  ...
  }, "\u662F\u5426\u5F00\u542F\u67E5\u770B\u6A21\u5F0F\uFF1A", /*#__PURE__*/React.createElement(Switch, {
    defaultChecked: true,
  ...
  })), /*#__PURE__*/React.createElement(KhtDrawerTree, {
    drawerProps: {
      visible: visible,
