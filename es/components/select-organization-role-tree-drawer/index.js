...
var SelectOrganizationRoleTreeDrawer = function SelectOrganizationRoleTreeDrawer(props) {
  var _props$open = props.open,
    open = _props$open === void 0 ? false : _props$open,
    _props$title = props.title,
    title = _props$title === void 0 ? '选择组织角色' : _props$title,
  ...
  var footerRender = /*#__PURE__*/React.createElement("div", {
    className: "select-organization-role-drawer-tree-footer"
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Drawer, {
    ...
    title: title,
    width: width,
    className: "select-organization-role-drawer-tree-wrapper",
    onClose: onCancel,
    ...
    className: "select-organization-role-bottom-title",
...
export default SelectOrganizationRoleTreeDrawer;
