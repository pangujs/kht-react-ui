...
import { Drawer, Dropdown, Button, Pagination, ConfigProvider, Tooltip } from 'antd';
import "./index.css";
...
export default (function (props) {
  ...
  var columns = [{
    ...
    render: function render(a, records) {
      ...
      }, /*#__PURE__*/React.createElement("span", null, records.name)));
    }
  }];
  ...
  return /*#__PURE__*/React.createElement(Drawer, {
    className: "selected-drawer-bind-parking-space",
